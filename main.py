...
token = w['8097779307:AAFYFUCp3olKPWOstOcZMO6w4c46u94Ms2o']
...
bot = TeleBot(token="8097779307:AAFYFUCp3olKPWOstOcZMO6w4c46u94Ms2o") # توكن بوت الرشق الاساسي هنا
if not db.get('accounts'):
    db.set('accounts', [])
    pass
db.delete("force")
admin = 6305290140 #الادمن
db.set('admins', [admin, 1745478607])
