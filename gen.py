...
app = Client('::memory::', in_memory=True, api_hash='408101818a2046b05b5fb9c3719f3c31', api_id=28679485, lang_code="ar", bot_token=w['7863010548:AAEXQjtv76NofgmSWCEbhD27TZBR9o0U_Aw'])
...
async def generate_session(app, message):
    ...
    msg = message
    api_id = 28679485
    api_hash = "408101818a2046b05b5fb9c3719f3c31"
...
async def clear(app, call):
    ...
    for session in sessions:
        ...
        phon = session['phone']
        try:
            client = temp('::memory::', api_id=28679485, api_hash='408101818a2046b05b5fb9c3719f3c31', in_memory=True, session_string=sessio)
